import { Close, Null, Plus, Times } from "@assets/index";
import NoteListItem from "@components/Nurse/NurseDetail/ModalContent/Note/NoteListItem";
              ...
              updatesAllowed && (
                <>
                  <button
                    ...
                    className="detail-button primary-button flex-grow-1 px-2 px-md-3"
                  >
            ...
            <div className="row">
              <div className="col-12">
                <ul className="list-group gap-3">
                  {reverseArr(data?.prescriber_notes)?.map((item, index) => (
                    <NoteListItem
                      item={item}
                      ...
                      key={index}
                      noteOwnerShip={item.note_ownership == "Nurse"?"Nurse": "Self"}
